...
// 	dao := pDao.InitializeGormDao(gormDB)
...
// 	prescription2 := &entity.Prescription{
// 		ID:         uuid.New(),
// 		Medication: StringPointer("Sample Medication"),
// 		Dosage:     StringPointer("Sample Dosage"),
// 		Notes:      StringPointer("Sample Notes"),
...
// 	mock.ExpectQuery("SELECT .* FROM \"prescriptions\"").
// 		WithArgs(email, id, 1).WillReturnError(gorm.ErrRecordNotFound)
...
// 	var expectedErr *apperror.ResourceNotFound
// 	if errors.As(err, &expectedErr) {
// 		assert.Equal(t, 404, expectedErr.Code)
// 	} else {
// 		t.Fatalf("Expected error of type *apperror.ResourceNotFound, but got %v", err)
// 	}
// }
...
// 	id1 := uuid.New()
// 	expectedOne := &entity.Prescription{
// 		ID:         id1,
// 		Medication: StringPointer("Sample Medication"),
// 		Dosage:     StringPointer("Sample Dosage"),
// 		Notes:      StringPointer("Sample Notes"),
...
// 	id2 := uuid.New()
// 	expectedTwo := &entity.Prescription{
// 		ID:         id2,
...
// 	updatedPrescription := &entity.Prescription{
// 		ID:         prescription.ID,
